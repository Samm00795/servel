                   ...
                   <nav class="navbar navbar-default">
                    ...
                    <div class="row text-center">
                        <div class="col-md-3">
                            ...
                            <p ><a href="cliente.php">Ingresar a cliente</a></p>
                        </div>
                        <div class="col-md-3">
                             <h3>Personal</h3>
                             <img src="img/personal.jpg" class="img img-responsive">
                             <p><a href="personal.php">Ingresar personal</a></p>
                        </div>
                        <div class="col-md-3">
                             <h3>Producto</h3>
                             <img src="img/producto.png" class="img img-responsive">
                             <p><a href="producto.php">Ingresar a producto</a></p>
                        </div>
                        <div class="col-md-3">
                             <h3>Boleta</h3>
                    ...
                    <div class="row text-center">
                        <div class="col-md-3">
                            ...
                            <p ><a href="proveedor.php">Ingresar a proveedor</a></p>
                        </div>
                        <div class="col-md-3">
                             <h3>Categoria</h3>
                             <img src="img/Categoria.jpg" class="img img-responsive">
                             <p><a href="categoria.php">Ingresar a categoria</a></p>
                        </div>
                        <div class="col-md-3">
                             <h3>Detalle de Boleta</h3>
                             <img src="img/inventario.png" class="img img-responsive">
                             <p><a href="#.php">Ingresar a detalle de boleta</a></p>
                        </div>
