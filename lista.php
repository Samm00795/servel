		...
		<div class="container">
           <div class="row">
                <div class="col-md-2">
                        ...
                        <a href="logout.php" class="btn btn-info btn-block btn-danger" role="button">Cerrar sesión</a> <br>
                   ...
                   <nav class="navbar navbar-default">
                    ...
                    <div class="row text-center">
                        <div class="col-md-3">
                            ...
                            <p align="center"><a href="listacliente.php">Ingresar cliente</a></p>
                        </div>
                        <div class="col-md-3">
                             <h3>Personal</h3>
                             <img src="img/personal.jpg" class="img img-responsive">
                             <p align="center"><a href="listapersonal.php">Ingresar personal</a></p>
                        </div>
                        <div class="col-md-3">
                             <h3>Producto</h3>
                             <img src="img/producto.png" class="img img-responsive">
                             <p align="center"><a href="listaproducto.php">Ingresar producto</a></p>
                        </div>
                        <div class="col-md-3">
                             <h3>Boleta</h3>
                             <img src="img/usuario.png" class="img img-responsive">
                             <p align="center"><a href="listaproducto.php">Ingresar Boleta</a></p>
                        </div>
                    </div>     
                    ...
                    <div class="row text-center">
                        <div class="col-md-3">
                            ...
                            <p align="center"><a href="listaproveedor.php">Ingresar a proveedor</a></p>
                        </div>
                        <div class="col-md-3">
                             <h3>Categoria</h3>
                             <img src="img/Categoria.jpg" class="img img-responsive">
                             <p align="center"><a href="listacategoria.php">Ingresar a categoria</a></p>
                        </div>
                        
                        <div class="col-md-3">
                             <h3>Detalle de Boleta</h3>
                             <img src="img/inventario.png" class="img img-responsive">
                             <p align="center"><a href="#">Ingresar a detalle de boleta</a></p>
                        </div>
                    </div> 
                </div>
